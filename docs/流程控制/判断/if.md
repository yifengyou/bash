...
![20191109_124541_22](image/20191109_124541_22.png)

* **这里变量只是单纯的进行替换，如果变量为空，那么会造成if语法不完全的错误**

如果没有提供参数，那么替换掉 $NAME 变量后变成

```if [ = "nic" ];then echo "NAME is nic";else echo "Name is $1";fi```

改进一：

对于当前bash环境有效，但是其他shell环境不一定可以

![20191109_124733_17](image/20191109_124733_17.png)

改进二：

此种改进移植性更好

![20191109_125634_74](image/20191109_125634_74.png)

如果$NAME为空，那么就变成如下形式，不影响结果
...
set相关内容参看：[set](docs/bash内置命令/set.md)

![20191109_112408_17](image/20191109_112408_17.png)

* set选项需要全写，不得简写，简写没效果
* $- 特殊环境变量可以查看set设定的标记
